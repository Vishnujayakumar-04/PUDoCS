/**
 * M.Sc Data Analytics 1st Year Student List
 * Complete list of students with Registration Number and Name
 * Note: This is M.Sc Data Analytics (different from M.Tech Data Analytics)
 */

export const MSC_DA_1ST_YEAR_STUDENTS = [
 ...
 */
export const formatMscDA1stYearStudentData = (registerNumber, name) => ({
