...
export const getDefaultSubjects = (program, year) => {
    ...
    if (program.includes('M.Tech') || program.includes('MTech')) {
        ...
        } else if (program.includes('CSE') || program.includes('Computer Science') || program.includes('CSE')) {
    ...
    } else if (program.includes('MCA') || programUpper.includes('MCA')) {
...
// Get subject code from subject name or code
...
// Get subject name from subject object
